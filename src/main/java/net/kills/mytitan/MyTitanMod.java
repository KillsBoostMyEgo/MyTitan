...
@Mod("my_titan")
public class MyTitanMod {
	public static final Logger LOGGER = LogManager.getLogger(MyTitanMod.class);
	public static final String MODID = "my_titan";

	public MyTitanMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		MyTitanModSounds.REGISTRY.register(modEventBus);
