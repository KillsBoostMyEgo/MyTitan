package net.kills.mytitan.client.renderer;
...
import net.kills.mytitan.item.model.ODMGearModel;
import net.kills.mytitan.item.ODMGearItem;

public class ODMGearArmorRenderer extends GeoArmorRenderer<ODMGearItem> {
	public ODMGearArmorRenderer() {
	...
	@Override
	public RenderType getRenderType(ODMGearItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
