...
import net.kills.mytitan.item.model.ODMModel;
import net.kills.mytitan.item.ODMItem;

public class ODMArmorRenderer extends GeoArmorRenderer<ODMItem> {
	public ODMArmorRenderer() {
		super(new ODMModel());
	...
	@Override
	public RenderType getRenderType(ODMItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
