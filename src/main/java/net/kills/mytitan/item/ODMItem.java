...
import net.kills.mytitan.client.renderer.ODMArmorRenderer;
...
public class ODMItem extends ArmorItem implements GeoItem {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	public String animationprocedure = "empty";

	public ODMItem(ArmorItem.Type type, Item.Properties properties) {
		...
		consumer.accept(new IClientItemExtensions() {
			...
			public HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
				if (this.renderer == null)
					this.renderer = new ODMArmorRenderer();
	...
	private PlayState predicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			...
			boolean isWearingAll = wornArmor.containsAll(ObjectArrayList.of(MyTitanModItems.ODM_LEGGINGS.get()
